...
public class ImageServiceImpl implements ImageService {
    ...
    @Override
    public String updateArticleImage(final Article article, final MultipartFile image) {
        try {
            String imageFilepath;
            File imageFile;
            if (article.getImage() != null) {
                imageFilepath = String.format("%s/%d%s", articleBaseFilepath, article.getId(), article.getImage());
            ...
            imageFilepath = String.format("%s/%d%s", articleBaseFilepath, article.getId(), image.getOriginalFilename());
            imageFile = new File(imageFilepath);
